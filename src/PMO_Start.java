...
public class PMO_Start {
	...
	public static void main(String[] args) {
		PMO_TestThreadsKeeper threadsKeeper = new PMO_TestThreadsKeeper();
		...
		result &= executeTest("Test A", () -> new PMO_TestA(threadsKeeper), 5);
		if (result)
			result &= executeTest("Test B", () -> new PMO_TestB(threadsKeeper), 5);
		if (result)
			result &= executeTest("Test C", () -> new PMO_TestC(threadsKeeper), 5);
